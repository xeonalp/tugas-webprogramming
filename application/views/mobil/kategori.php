                ...
                <tbody>
                    ...
                    foreach ($kategori as $k) { ?>
                        <tr>
                            ...
                            <td><?= $k['kategori']; ?></td>
                            <td>
                                <a href="<?= base_url('mobil/ubahMobil/') . $k['id']; ?>" class="badge badge-info"><i class="fas fa-edit"></i> Ubah</a>
                                <a href="<?= base_url('mobil/hapusmobil/') . $k['id']; ?>" onclick="return confirm('Kamu yakin akan menghapus <?= $judul . ' ' . $k['kategori']; ?>?');" class="badge badge-danger"><i class="fas fa-trash"></i>Hapus</a>
                            </td>
                        </tr>
                    <?php } ?>
                </tbody>
                ...
                <div class="modal-body">
                    <div class="form-group">
                        <select name="kategori" class="form-control form-control-user">
                            ...
                            <?php
                            $k = ['Sedan', 'MPV', 'SUV', 'Pick Up', 'Truck', 'Mini Bus', 'Bus'];
                            for ($i = 0; $i < 7; $i++) { ?>
